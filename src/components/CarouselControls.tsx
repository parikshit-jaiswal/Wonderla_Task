    ...
    return (
        <div className="">
            <div className="absolute top-2 right-14 flex gap-4">
                <button
                    className="px-4.5 py-3.5 hover:scale-105 transition-all transform rounded-full cursor-pointer bg-yellow-400"
                    type="button"
                    style={{ transition: "all 200ms" }}
                    onClick={onPrevSlide}
                >
                    <svg width="13" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 20">
                        <path
                            fill="#334DCF"
